...
export default function FullStatistic({
  ...
  return (
    <div
      className={`${cssFullStatistic.container} ${page !== 'statistics' ? cssFullStatistic.off : ''}`}
    >
      ...
      <h3 className={cssFullStatistic.stringContainer}>
        ...
        <div className={`${cssFullStatistic.value} ${cssFullStatistic.wordsRep}`}>
          {wordsRepClc[timeRange]}
        </div>
      </h3>
      <h3 className={cssFullStatistic.stringContainer}>
        <div className={cssFullStatistic.text + ' color2'}>sessions:</div>
        <div className={`${cssFullStatistic.value} ${cssFullStatistic.session}`}>
          {sessionClc[timeRange]}
        </div>
      </h3>
      <h3 className={cssFullStatistic.stringContainer}>
